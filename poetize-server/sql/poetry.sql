...
INSERT INTO `poetize`.`web_info`(`id`, `web_name`, `web_title`, `notices`, `footer`, `background_image`, `avatar`, `random_avatar`, `random_name`, `random_cover`, `waifu_json`, `status`) VALUES (1, 'Sara', 'POETIZE', '[]', '云想衣裳花想容， 更多资源bygoukai.com', '', '', '[]', '[]', '[]', '{}', 1);
